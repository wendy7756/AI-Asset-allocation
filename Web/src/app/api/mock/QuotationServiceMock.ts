...
export class QuotationServiceMock extends QuotationService {
  ...
  async getNews(): Promise<News[]> {
    ...
    return [
      { time: "09-16 17:38", content: "全球大学文凭“含金量”排名出炉：“北清复”名列30强\n" +
        ...
        "\t\t\t\n" +
        "\t\t\t责任编辑：孟行 \n" +
        "\t\t\t", title: "全球大学文凭\"含金量\"排名出炉:\"北清复\"名列…" },
      { time: "09-16 17:36",
        content: "新浪财经讯 山东黄金公告，根据发行上市的时间安排，" +
        "公司9月14日在香港刊登并派发H股招股说明书。公司H股香港公开发售于9月14日开始，9月20日结束" +
        "，并预计于9月27日或之前，公布国际发售和香港公开发售的认购情况及香港公开发售股份的分配结果。" +
        "H股预计9月28日在香港联交所挂牌并开始上市交易。责任编辑：白仲平 \n" +
        "\t",
