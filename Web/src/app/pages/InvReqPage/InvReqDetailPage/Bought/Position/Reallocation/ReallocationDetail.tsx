          ...
          <Col md={15} sm={24}>
            ...
            <Collapse accordion={true}>
              ...
              <Collapse.Panel
                header={<p>股票市场
                  <Link style={{float: "right", marginRight: "20px"}}
                        to={`/invreq/${invreqId}/position/reallocation/${TranData.time}/STOCK`}>
                    查看交易</Link>
                  </p>} key={"1"}>
                <Table size={"small"}
              ...
              <Collapse.Panel header={<p>债券市场
                <Link style={{float: "right", marginRight: "20px"}}
                      to={`/invreq/${invreqId}/position/reallocation/${TranData.time}/BOND`}>
                  查看交易</Link>
              </p>} key={"2"}>
                <Table size={"small"}
              ...
              <Collapse.Panel header={<p>商品市场
                <Link style={{float: "right", marginRight: "20px"}}
                      to={`/invreq/${invreqId}/position/reallocation/${TranData.time}/PRODUCT`}>
                  查看交易</Link>
              </p>} key={"3"}>
                <Table size={"small"}
